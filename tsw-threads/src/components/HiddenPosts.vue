...
const me = ref({})
const lastPage = ref(Number(localStorage.getItem("lastHiddenPage")) || 1)
...
async function nextPage(){
    lastPage.value++
    localStorage.setItem("lastHiddenPage",lastPage.value)
    getPosts()
}
...
onUnmounted(()=>{
    localStorage.removeItem("lastHiddenPage")
})
